# Go Backend Mastery - My 100 Days to FAANG-Ready Backend Engineer
...
**My target:** backend interviews at Apple, Meta, Google, NVIDIA, Microsoft, Netflix.
...
- **Google:** DSA-heavy; Go is a first-class language there. Know Borg/Omega (K8s' ancestor), Spanner (TrueTime), gRPC/protobuf deeply. "Googleyness" + structured communication.
- **Meta:** scale-first thinking; expect deep dives on trade-offs. Infra lore: TAO, ZippyDB, fb303. Move fast, measurable impact stories.
- **Apple:** strong on fundamentals and product-minded engineering; privacy/security angles score well. Backend roles exist across services (iCloud, App Store).
- **NVIDIA:** infra for AI - inference serving (batching, GPU scheduling, Triton concepts), distributed training infrastructure, high-throughput networking. Systems + performance depth wins.
- **Microsoft:** Azure-heavy; balanced DSA + system design. Clear, methodical communication; growth-mindset framing.
- **Netflix:** chaos engineering culture, microservices at scale (EVCache, Hollow, Zuul heritage). Freedom & responsibility - show ownership and data-driven decisions.
...
- *Release It!* / *Release It! 2nd ed* - Michael Nygard (production stability)
- *Distributed Systems* - Maarten van Steen & Andrew Tanenbaum (free PDF)

**Hands-on**

- [System Design Primer](https://github.com/donnemartin/system-design-primer) - donnemartin/system-design-primer
- [faang-playbook](https://github.com/swadhinbiswas/faang-playbook) - role roadmaps incl. backend
- [awesome-interview backend roadmap](https://github.com/cecil2026/awesome-interview) - week-by-week plan
- ByteByteGo (newsletter + YouTube) - system design visuals
- Hussein Nasser (YouTube) - networking & databases, deep and precise
- Gaurav Sen (YouTube) - system design interview walkthroughs
- Ardan Labs (YouTube/blog) - advanced Go

**Practice**

- Pramp / interviewing.io for mock interviews
- Build every drill as a real repo - interviewers remember builders
...
- [ ] 15+ system designs done timed & out loud
- [ ] 5+ portfolio projects, can whiteboard each one's architecture
- [ ] Can explain Raft, consistent hashing, quorums, isolation levels in 2 minutes each
- [ ] Hands-on: Docker + K8s manifests you wrote yourself
- [ ] 10+ STAR stories prepared (conflict, ownership, failure, scale)
- [ ] 5+ mock interviews (coding + system design)

---

*Day 1 starts with* `go version`*. Commit every day.*
